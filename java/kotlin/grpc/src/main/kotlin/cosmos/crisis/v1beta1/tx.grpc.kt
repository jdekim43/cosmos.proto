...
public object MsgService {
  ...
  public abstract class Server(
    ...
    public open suspend fun verifyInvariant(request: MsgVerifyInvariant): MsgVerifyInvariantResponse
        = throw
        ...
        ServerServiceDefinition.builder(descriptor)
    		.addMethod(
    			ServerCalls.unaryServerMethodDefinition(
    				...
    				implementation = {
        MsgVerifyInvariantResponseMapper.convert(verifyInvariant(MsgVerifyInvariantMapper.convert(it)))
        },
    			)
    		)
    		.addMethod(
  ...
  public class Client(
    ...
    public suspend fun verifyInvariant(request: MsgVerifyInvariant, metadata: Metadata =
        Metadata()): MsgVerifyInvariantResponse = MsgVerifyInvariantResponseMapper.convert(
    		ClientCalls.unaryRpc(
    			channel, verifyInvariantDescriptor,
    			MsgVerifyInvariantMapper.convert(request),
