...
public object FileDescriptorSetMapper :
  ...
  public override fun convert(obj: DescriptorProtos.FileDescriptorSet): FileDescriptorSet =
      FileDescriptorSet(
  	`file` = obj.fileList.map { FileDescriptorProtoMapper.convert(it) },
  )
  ...
  public override fun convert(obj: FileDescriptorSet): DescriptorProtos.FileDescriptorSet {
    ...
    builder.addAllFile(obj.`file`.map { FileDescriptorProtoMapper.convert(it) })
    return builder.build()
  }
}

public object FileDescriptorProtoMapper :
  ...
  public override fun convert(obj: DescriptorProtos.FileDescriptorProto): FileDescriptorProto =
  	...
  	messageType = obj.messageTypeList.map { DescriptorProtoMapper.convert(it) },
  	enumType = obj.enumTypeList.map { EnumDescriptorProtoMapper.convert(it) },
  	service = obj.serviceList.map { ServiceDescriptorProtoMapper.convert(it) },
  	extension = obj.extensionList.map { FieldDescriptorProtoMapper.convert(it) },
  	options = FileOptionsMapper.convert(obj.options),
  	sourceCodeInfo = SourceCodeInfoMapper.convert(obj.sourceCodeInfo),
  	syntax = obj.syntax,
  	edition = obj.edition,
  )
  ...
  public override fun convert(obj: FileDescriptorProto): DescriptorProtos.FileDescriptorProto {
    ...
    builder.addAllMessageType(obj.messageType.map { DescriptorProtoMapper.convert(it) })
    builder.addAllEnumType(obj.enumType.map { EnumDescriptorProtoMapper.convert(it) })
    builder.addAllService(obj.service.map { ServiceDescriptorProtoMapper.convert(it) })
    builder.addAllExtension(obj.extension.map { FieldDescriptorProtoMapper.convert(it) })
    val value9 = obj.options
    if (value9 != null) {
      builder.setOptions(FileOptionsMapper.convert(value9))
    }
    val value10 = obj.sourceCodeInfo
    if (value10 != null) {
      builder.setSourceCodeInfo(SourceCodeInfoMapper.convert(value10))
    }
...
public object DescriptorProtoMapper :
  ...
  public override fun convert(obj: DescriptorProtos.DescriptorProto): DescriptorProto =
      DescriptorProto(
  	name = obj.name,
  	`field` = obj.fieldList.map { FieldDescriptorProtoMapper.convert(it) },
  	extension = obj.extensionList.map { FieldDescriptorProtoMapper.convert(it) },
  	nestedType = obj.nestedTypeList.map { DescriptorProtoMapper.convert(it) },
  	enumType = obj.enumTypeList.map { EnumDescriptorProtoMapper.convert(it) },
  	extensionRange = obj.extensionRangeList.map { ExtensionRangeMapper.convert(it) },
  	oneofDecl = obj.oneofDeclList.map { OneofDescriptorProtoMapper.convert(it) },
  	options = MessageOptionsMapper.convert(obj.options),
  	reservedRange = obj.reservedRangeList.map { ReservedRangeMapper.convert(it) },
  ...
  public override fun convert(obj: DescriptorProto): DescriptorProtos.DescriptorProto {
    ...
    builder.addAllField(obj.`field`.map { FieldDescriptorProtoMapper.convert(it) })
    builder.addAllExtension(obj.extension.map { FieldDescriptorProtoMapper.convert(it) })
    builder.addAllNestedType(obj.nestedType.map { DescriptorProtoMapper.convert(it) })
    builder.addAllEnumType(obj.enumType.map { EnumDescriptorProtoMapper.convert(it) })
    builder.addAllExtensionRange(obj.extensionRange.map { ExtensionRangeMapper.convert(it) })
    builder.addAllOneofDecl(obj.oneofDecl.map { OneofDescriptorProtoMapper.convert(it) })
    val value7 = obj.options
    if (value7 != null) {
      builder.setOptions(MessageOptionsMapper.convert(value7))
    }
    builder.addAllReservedRange(obj.reservedRange.map { ReservedRangeMapper.convert(it) })
    builder.addAllReservedName(obj.reservedName.map { it })
    return builder.build()
  }

  public object ExtensionRangeMapper :
    ...
    public override fun convert(obj: DescriptorProtos.DescriptorProto.ExtensionRange):
    	...
    	options = ExtensionRangeOptionsMapper.convert(obj.options),
    )
    ...
    public override fun convert(obj: DescriptorProto.ExtensionRange):
      ...
      if (value2 != null) {
        builder.setOptions(ExtensionRangeOptionsMapper.convert(value2))
      }
      return builder.build()
    }
  }

  public object ReservedRangeMapper :
...
public object ExtensionRangeOptionsMapper :
  ...
  public override fun convert(obj: DescriptorProtos.ExtensionRangeOptions): ExtensionRangeOptions =
  	...
  	uninterpretedOption = obj.uninterpretedOptionList.map { UninterpretedOptionMapper.convert(it) },
  )
  ...
  public override fun convert(obj: ExtensionRangeOptions): DescriptorProtos.ExtensionRangeOptions {
    ...
    builder.addAllUninterpretedOption(obj.uninterpretedOption.map {
        UninterpretedOptionMapper.convert(it) })
    return builder.build()
  }
}

public object FieldDescriptorProtoMapper :
  ...
  public override fun convert(obj: DescriptorProtos.FieldDescriptorProto): FieldDescriptorProto =
  	...
  	options = FieldOptionsMapper.convert(obj.options),
  ...
  public override fun convert(obj: FieldDescriptorProto): DescriptorProtos.FieldDescriptorProto {
    ...
    val value9 = obj.options
    if (value9 != null) {
      builder.setOptions(FieldOptionsMapper.convert(value9))
    }
...
public object OneofDescriptorProtoMapper :
  ...
  public override fun convert(obj: DescriptorProtos.OneofDescriptorProto): OneofDescriptorProto =
  	...
  	name = obj.name,
  	options = OneofOptionsMapper.convert(obj.options),
  )
  ...
  public override fun convert(obj: OneofDescriptorProto): DescriptorProtos.OneofDescriptorProto {
    ...
    if (value1 != null) {
      builder.setOptions(OneofOptionsMapper.convert(value1))
    }
    return builder.build()
  }
}

public object EnumDescriptorProtoMapper :
  ...
  public override fun convert(obj: DescriptorProtos.EnumDescriptorProto): EnumDescriptorProto =
      EnumDescriptorProto(
  	name = obj.name,
  	`value` = obj.valueList.map { EnumValueDescriptorProtoMapper.convert(it) },
  	options = EnumOptionsMapper.convert(obj.options),
  	reservedRange = obj.reservedRangeList.map { EnumReservedRangeMapper.convert(it) },
  	reservedName = obj.reservedNameList.map { it },
  )
  ...
  public override fun convert(obj: EnumDescriptorProto): DescriptorProtos.EnumDescriptorProto {
    ...
    builder.addAllValue(obj.`value`.map { EnumValueDescriptorProtoMapper.convert(it) })
    val value2 = obj.options
    if (value2 != null) {
      builder.setOptions(EnumOptionsMapper.convert(value2))
    }
    builder.addAllReservedRange(obj.reservedRange.map { EnumReservedRangeMapper.convert(it) })
    builder.addAllReservedName(obj.reservedName.map { it })
    return builder.build()
  }

  public object EnumReservedRangeMapper :
...
public object EnumValueDescriptorProtoMapper :
  ...
  public override fun convert(obj: DescriptorProtos.EnumValueDescriptorProto):
  	...
  	name = obj.name,
  	number = obj.number,
  	options = EnumValueOptionsMapper.convert(obj.options),
  )
  ...
  public override fun convert(obj: EnumValueDescriptorProto):
    ...
    val value2 = obj.options
    if (value2 != null) {
      builder.setOptions(EnumValueOptionsMapper.convert(value2))
    }
    return builder.build()
  }
}

public object ServiceDescriptorProtoMapper :
  ...
  public override fun convert(obj: DescriptorProtos.ServiceDescriptorProto): ServiceDescriptorProto
  	...
  	name = obj.name,
  	method = obj.methodList.map { MethodDescriptorProtoMapper.convert(it) },
  	options = ServiceOptionsMapper.convert(obj.options),
  )
  ...
  public override fun convert(obj: ServiceDescriptorProto):
    ...
    builder.addAllMethod(obj.method.map { MethodDescriptorProtoMapper.convert(it) })
    val value2 = obj.options
    if (value2 != null) {
      builder.setOptions(ServiceOptionsMapper.convert(value2))
    }
    return builder.build()
  }
}

public object MethodDescriptorProtoMapper :
  ...
  public override fun convert(obj: DescriptorProtos.MethodDescriptorProto): MethodDescriptorProto =
  	...
  	options = MethodOptionsMapper.convert(obj.options),
  ...
  public override fun convert(obj: MethodDescriptorProto): DescriptorProtos.MethodDescriptorProto {
    ...
    if (value3 != null) {
      builder.setOptions(MethodOptionsMapper.convert(value3))
    }
...
public object FileOptionsMapper : ProtobufTypeMapper<FileOptions, DescriptorProtos.FileOptions> {
  public override val descriptor: Descriptors.Descriptor =
...
public object MessageOptionsMapper :
  ...
  public override fun convert(obj: DescriptorProtos.MessageOptions): MessageOptions =
  	...
  	deprecatedLegacyJsonFieldConflicts = obj.deprecatedLegacyJsonFieldConflicts,
  	uninterpretedOption = obj.uninterpretedOptionList.map { UninterpretedOptionMapper.convert(it) },
  )
...
public object FieldOptionsMapper : ProtobufTypeMapper<FieldOptions, DescriptorProtos.FieldOptions> {
  public override val descriptor: Descriptors.Descriptor =
  ...
  public override fun convert(obj: DescriptorProtos.FieldOptions): FieldOptions = FieldOptions(
  	...
  	deprecated = obj.deprecated,
  	weak = obj.weak,
  	debugRedact = obj.debugRedact,
  	retention = FieldOptions.OptionRetention.forNumber(obj.retention.number),
  	target = FieldOptions.OptionTargetType.forNumber(obj.target.number),
  	uninterpretedOption = obj.uninterpretedOptionList.map { UninterpretedOptionMapper.convert(it) },
  )
...
public object OneofOptionsMapper : ProtobufTypeMapper<OneofOptions, DescriptorProtos.OneofOptions> {
  public override val descriptor: Descriptors.Descriptor =
...
public object EnumOptionsMapper : ProtobufTypeMapper<EnumOptions, DescriptorProtos.EnumOptions> {
  public override val descriptor: Descriptors.Descriptor =
...
public object EnumValueOptionsMapper :
...
public object ServiceOptionsMapper :
...
public object MethodOptionsMapper :
...
public object UninterpretedOptionMapper :
  ...
  public override fun convert(obj: DescriptorProtos.UninterpretedOption): UninterpretedOption =
      UninterpretedOption(
  	name = obj.nameList.map { NamePartMapper.convert(it) },
  ...
  public override fun convert(obj: UninterpretedOption): DescriptorProtos.UninterpretedOption {
    ...
    builder.addAllName(obj.name.map { NamePartMapper.convert(it) })
...
public object SourceCodeInfoMapper :
  ...
  public override fun convert(obj: DescriptorProtos.SourceCodeInfo): SourceCodeInfo =
      SourceCodeInfo(
  	location = obj.locationList.map { LocationMapper.convert(it) },
  )
  ...
  public override fun convert(obj: SourceCodeInfo): DescriptorProtos.SourceCodeInfo {
    ...
    builder.addAllLocation(obj.location.map { LocationMapper.convert(it) })
    return builder.build()
  }

  public object LocationMapper :
...
public object GeneratedCodeInfoMapper :
  ...
  public override fun convert(obj: DescriptorProtos.GeneratedCodeInfo): GeneratedCodeInfo =
      GeneratedCodeInfo(
  	`annotation` = obj.annotationList.map { AnnotationMapper.convert(it) },
  )
  ...
  public override fun convert(obj: GeneratedCodeInfo): DescriptorProtos.GeneratedCodeInfo {
    ...
    builder.addAllAnnotation(obj.`annotation`.map { AnnotationMapper.convert(it) })
    return builder.build()
  }

  public object AnnotationMapper :
    ...
    public override fun convert(obj: DescriptorProtos.GeneratedCodeInfo.Annotation):
    	...
    	semantic = GeneratedCodeInfo.Annotation.Semantic.forNumber(obj.semantic.number),
    )
