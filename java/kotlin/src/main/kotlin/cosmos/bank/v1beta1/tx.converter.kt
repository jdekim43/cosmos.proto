...
public object MsgSendMapper : ProtobufTypeMapper<MsgSend, Tx.MsgSend> {
...
public object MsgSendResponseMapper : ProtobufTypeMapper<MsgSendResponse, Tx.MsgSendResponse> {
...
public object MsgMultiSendMapper : ProtobufTypeMapper<MsgMultiSend, Tx.MsgMultiSend> {
  ...
  public override fun convert(obj: Tx.MsgMultiSend): MsgMultiSend = MsgMultiSend(
  	inputs = obj.inputsList.map { InputMapper.convert(it) },
  	outputs = obj.outputsList.map { OutputMapper.convert(it) },
  )

  public override fun convert(obj: MsgMultiSend): Tx.MsgMultiSend {
    val builder = Tx.MsgMultiSend.newBuilder()
    builder.addAllInputs(obj.inputs.map { InputMapper.convert(it) })
    builder.addAllOutputs(obj.outputs.map { OutputMapper.convert(it) })
    return builder.build()
  }
}

public object MsgMultiSendResponseMapper :
...
public object MsgSetSendEnabledMapper : ProtobufTypeMapper<MsgSetSendEnabled, Tx.MsgSetSendEnabled>
    {
...
public object MsgSetSendEnabledResponseMapper :
