...
public object ParamsMapper : ProtobufTypeMapper<Params, Distribution.Params> {
...
public object ValidatorHistoricalRewardsMapper :
  ...
  public override fun convert(obj: Distribution.ValidatorHistoricalRewards):
  	...
  	cumulativeRewardRatio = obj.cumulativeRewardRatioList.map { DecCoinMapper.convert(it) },
  ...
  public override fun convert(obj: ValidatorHistoricalRewards):
    ...
    builder.addAllCumulativeRewardRatio(obj.cumulativeRewardRatio.map { DecCoinMapper.convert(it) })
    builder.setReferenceCount(obj.referenceCount.asJavaType)
    return builder.build()
  }
}

public object ValidatorCurrentRewardsMapper :
...
public object ValidatorAccumulatedCommissionMapper :
...
public object ValidatorOutstandingRewardsMapper :
...
public object ValidatorSlashEventMapper :
...
public object ValidatorSlashEventsMapper :
  ...
  public override fun convert(obj: Distribution.ValidatorSlashEvents): ValidatorSlashEvents =
  	...
  	validatorSlashEvents = obj.validatorSlashEventsList.map { ValidatorSlashEventMapper.convert(it)
      },
  )
  ...
  public override fun convert(obj: ValidatorSlashEvents): Distribution.ValidatorSlashEvents {
    ...
    builder.addAllValidatorSlashEvents(obj.validatorSlashEvents.map {
        ValidatorSlashEventMapper.convert(it) })
    return builder.build()
  }
}

public object FeePoolMapper : ProtobufTypeMapper<FeePool, Distribution.FeePool> {
  ...
  public override fun convert(obj: Distribution.FeePool): FeePool = FeePool(
  	communityPool = obj.communityPoolList.map { DecCoinMapper.convert(it) },
  )

  public override fun convert(obj: FeePool): Distribution.FeePool {
    val builder = Distribution.FeePool.newBuilder()
    builder.addAllCommunityPool(obj.communityPool.map { DecCoinMapper.convert(it) })
    return builder.build()
  }
}

public object CommunityPoolSpendProposalMapper :
...
public object DelegatorStartingInfoMapper :
...
public object DelegationDelegatorRewardMapper :
  ...
  public override fun convert(obj: Distribution.DelegationDelegatorReward):
  	...
  	reward = obj.rewardList.map { DecCoinMapper.convert(it) },
  )
  ...
  public override fun convert(obj: DelegationDelegatorReward):
    ...
    builder.addAllReward(obj.reward.map { DecCoinMapper.convert(it) })
    return builder.build()
  }
}

public object CommunityPoolSpendProposalWithDepositMapper :
