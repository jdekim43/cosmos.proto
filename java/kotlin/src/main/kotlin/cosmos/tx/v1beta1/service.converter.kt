...
import cosmos.base.abci.v1beta1.GasInfoMapper
import cosmos.base.abci.v1beta1.ResultMapper
import cosmos.base.abci.v1beta1.TxResponseMapper
...
import tendermint.types.BlockMapper

public object GetTxsEventRequestMapper :
...
public object GetTxsEventResponseMapper :
  ...
  public override fun convert(obj: ServiceOuterClass.GetTxsEventResponse): GetTxsEventResponse =
      GetTxsEventResponse(
  	txs = obj.txsList.map { TxMapper.convert(it) },
  	txResponses = obj.txResponsesList.map { TxResponseMapper.convert(it) },
  ...
  public override fun convert(obj: GetTxsEventResponse): ServiceOuterClass.GetTxsEventResponse {
    ...
    builder.addAllTxs(obj.txs.map { TxMapper.convert(it) })
    builder.addAllTxResponses(obj.txResponses.map { TxResponseMapper.convert(it) })
...
public object BroadcastTxRequestMapper :
...
public object BroadcastTxResponseMapper :
  ...
  public override fun convert(obj: ServiceOuterClass.BroadcastTxResponse): BroadcastTxResponse =
      BroadcastTxResponse(
  	txResponse = TxResponseMapper.convert(obj.txResponse),
  )
  ...
  public override fun convert(obj: BroadcastTxResponse): ServiceOuterClass.BroadcastTxResponse {
    ...
    builder.setTxResponse(TxResponseMapper.convert(obj.txResponse))
    return builder.build()
  }
}

public object SimulateRequestMapper :
  ...
  public override fun convert(obj: SimulateRequest): ServiceOuterClass.SimulateRequest {
    ...
    builder.setTx(TxMapper.convert(obj.tx))
    builder.setTxBytes(ByteString.copyFrom(obj.txBytes))
    return builder.build()
  }
}

public object SimulateResponseMapper :
...
public object GetTxRequestMapper : ProtobufTypeMapper<GetTxRequest, ServiceOuterClass.GetTxRequest>
    {
  public override val descriptor: Descriptors.Descriptor =
...
public object GetTxResponseMapper :
...
public object GetBlockWithTxsRequestMapper :
...
public object GetBlockWithTxsResponseMapper :
  ...
  public override fun convert(obj: ServiceOuterClass.GetBlockWithTxsResponse):
  	...
  	block = BlockMapper.convert(obj.block),
  	pagination = PageResponseMapper.convert(obj.pagination),
  )
  ...
  public override fun convert(obj: GetBlockWithTxsResponse):
    ...
    builder.setBlock(BlockMapper.convert(obj.block))
    builder.setPagination(PageResponseMapper.convert(obj.pagination))
    return builder.build()
  }
}

public object TxDecodeRequestMapper :
...
public object TxDecodeResponseMapper :
...
public object TxEncodeRequestMapper :
...
public object TxEncodeResponseMapper :
...
public object TxEncodeAminoRequestMapper :
...
public object TxEncodeAminoResponseMapper :
...
public object TxDecodeAminoRequestMapper :
...
public object TxDecodeAminoResponseMapper :
