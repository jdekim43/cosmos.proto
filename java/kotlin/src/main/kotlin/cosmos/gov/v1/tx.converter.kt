...
public object MsgSubmitProposalMapper : ProtobufTypeMapper<MsgSubmitProposal, Tx.MsgSubmitProposal>
  ...
  public override fun convert(obj: Tx.MsgSubmitProposal): MsgSubmitProposal = MsgSubmitProposal(
  	...
  	initialDeposit = obj.initialDepositList.map { CoinMapper.convert(it) },
  ...
  public override fun convert(obj: MsgSubmitProposal): Tx.MsgSubmitProposal {
    ...
    builder.addAllInitialDeposit(obj.initialDeposit.map { CoinMapper.convert(it) })
...
public object MsgExecLegacyContentMapper :
...
public object MsgExecLegacyContentResponseMapper :
...
public object MsgVoteWeightedMapper : ProtobufTypeMapper<MsgVoteWeighted, Tx.MsgVoteWeighted> {
...
public object MsgVoteWeightedResponseMapper :
...
public object MsgDepositMapper : ProtobufTypeMapper<MsgDeposit, Tx.MsgDeposit> {
...
public object MsgDepositResponseMapper :
