...
public object ConfigRequestMapper : ProtobufTypeMapper<ConfigRequest, Query.ConfigRequest> {
...
public object ConfigResponseMapper : ProtobufTypeMapper<ConfigResponse, Query.ConfigResponse> {
