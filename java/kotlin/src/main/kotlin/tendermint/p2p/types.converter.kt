...
public object NetAddressMapper : ProtobufTypeMapper<NetAddress, Types.NetAddress> {
...
public object ProtocolVersionMapper : ProtobufTypeMapper<ProtocolVersion, Types.ProtocolVersion> {
...
public object DefaultNodeInfoMapper : ProtobufTypeMapper<DefaultNodeInfo, Types.DefaultNodeInfo> {
  ...
  public override fun convert(obj: Types.DefaultNodeInfo): DefaultNodeInfo = DefaultNodeInfo(
  	protocolVersion = ProtocolVersionMapper.convert(obj.protocolVersion),
  	...
  	moniker = obj.moniker,
  	other = DefaultNodeInfoOtherMapper.convert(obj.other),
  )

  public override fun convert(obj: DefaultNodeInfo): Types.DefaultNodeInfo {
    val builder = Types.DefaultNodeInfo.newBuilder()
    builder.setProtocolVersion(ProtocolVersionMapper.convert(obj.protocolVersion))
    ...
    builder.setOther(DefaultNodeInfoOtherMapper.convert(obj.other))
    return builder.build()
  }
}

public object DefaultNodeInfoOtherMapper :
